...
def handle_message(event):
    ...
    #         )
        ...
        param = {'mychannel': 'R'}
        requests.get(
            'http://vanlenth6.hopto.org:8080/stanly/stanly/tvAction!openTv.action',
            params=param)
        line_bot_api.reply_message(event.reply_token,
                                   TextSendMessage(text=content))
    elif "節目" in text:
        ...
        param = {'mychannel': 'C'}
        requests.get(
            'http://vanlenth6.hopto.org:8080/stanly/stanly/tvAction!toRoom.action',
            params=param)
        line_bot_api.reply_message(event.reply_token,
                                   TextSendMessage(text=content))
    elif "電視" in text:
        ...
        param = {'mychannel': 'A'}
        requests.get(
            'http://vanlenth6.hopto.org:8080/stanly/stanly/tvAction!toTv.action',
            params=param)
        line_bot_api.reply_message(event.reply_token,
                                   TextSendMessage(text=content))
    elif "開電腦" in text:
